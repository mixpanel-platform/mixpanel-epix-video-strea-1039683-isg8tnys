...
MP.api.segment('Video Start', 'Movie Title', params).done(function(results){
  ...
  $('#android-table #movie-2').text(names[3])
  $('#android-table #movie-3').text(names[1])
  $('#android-table #movie-4').text(names[2])
  $('#android-table #movie-5').text(names[4])
  //set stream values
  $('#android-table #value-1').text(dataValues[0])
  $('#android-table #value-2').text(dataValues[3])
  $('#android-table #value-3').text(dataValues[1])
  $('#android-table #value-4').text(dataValues[2])
...
MP.api.segment('Video Start', 'Movie Title', params).done(function(results){
  ...
  //set movie titles
  $('#roku-table #movie-1').text(names[3])
  $('#roku-table #movie-2').text(names[0])
  $('#roku-table #movie-3').text(names[4])
  $('#roku-table #movie-4').text(names[1])
  $('#roku-table #movie-5').text(names[2])
  //set stream values
  $('#roku-table #value-1').text(dataValues[3])
  $('#roku-table #value-2').text(dataValues[0])
  $('#roku-table #value-3').text(dataValues[4])
  $('#roku-table #value-4').text(dataValues[1])
  $('#roku-table #value-5').text(dataValues[2])
})
...
MP.api.segment('Video Start', 'Movie Title', params).done(function(results){
  ...
  //set movie titles
  $('#apple-tv-table #movie-1').text(names[3])
  $('#apple-tv-table #movie-2').text(names[0])
  $('#apple-tv-table #movie-3').text(names[4])
  $('#apple-tv-table #movie-4').text(names[1])
  $('#apple-tv-table #movie-5').text(names[2])
  //set stream values
  $('#apple-tv-table #value-1').text(dataValues[3])
  $('#apple-tv-table #value-2').text(dataValues[0])
  $('#apple-tv-table #value-3').text(dataValues[4])
  $('#apple-tv-table #value-4').text(dataValues[1])
  $('#apple-tv-table #value-5').text(dataValues[2])
})
